namespace EventManager.Api.AspNetCore.Controllers
{
    ...
    [Route("api/[controller]", Name = "SpeakersRoute")]
    public class SpeakersController : Controller
    {
        private readonly ISpeakersApplication application;

        public SpeakersController(
            ISpeakersApplication application)
        {
        ...
        // POST api/values
        [HttpPost]
        public IActionResult Post([FromBody]SpeakerDto dto)
        {
        ...
        // PUT api/values/5
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody]SpeakerDto dto)
        {
            if (dto == null) return BadRequest();
            dto.Id = id;
